...
- **If you add/rename/remove any internal UI message keys (localization) or supported locales (e.g. en-US/en-GB), update `README.md` and keep guidance in `STYLING-CSS-GUIDE.md` (Localization note) consistent.**
